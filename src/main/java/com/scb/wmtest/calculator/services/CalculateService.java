...
public class CalculateService {
    ...
    /**
     * Performs the specified mathematical operation on two integers
     * 
     ...
     */
    public int performAction(String action, int val1, int val2) {
        ...
        if (operation == null) {
            ...
            throw new CalculatorException("Invalid operation: " + action + ". Supported operations: sum, subtract, multiply, divide", "INVALID_OPERATION");
        }
